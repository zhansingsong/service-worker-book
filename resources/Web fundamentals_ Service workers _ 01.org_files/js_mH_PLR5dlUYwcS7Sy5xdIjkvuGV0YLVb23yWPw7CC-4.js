    ...
    return this.each(function() {
      ...
      if (o.initShow) {
        $(Obj).find(o.initShow).show().addClass('shown')
          ...
          if (o.expandSub) {$(Obj + ' ' + o.initShow).parent().children(o.next).show().end().find('> a').addClass('open').data('state', 1 );}
      }
      // event
      if (o.event == 'click') {
          var ev = 'click';
...
(function ($) {
  $(document).ready(function() {
    ...
    /*$('#project-navigation').accordion({
        container: false,
        initShow: '.expanded .active'
    });*/
    
    // Process spans using the parent link.
    $('#project-navigation li').click(function(e) {
      if (!$(e.target).attr('href')) {
        // Turn off fx
        $.fx.off = true;
        
        // Remove elements in the DOM to prevent the animation.
        var sub_menu = $(this).find('ul:first')[0];
        $(sub_menu).slideToggle().parent().toggleClass('active-trail');
...
$.fn.fadeInOutAndRemove = function(fadeIn, delay, fadeOut) {
